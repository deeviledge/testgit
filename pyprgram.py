...
sound_effect1=pygame.mixer.Sound( sound1 )
sound_effect2=pygame.mixer.Sound( sound2 )

#pygame.mixer.music.set_volume( play_volume/100 )
pygame.mixer.Sound.set_volume( play_volume/100 )
...
while True:
	...
	if mem[ch] == -1:
	    ...
	    ii += 1
            ...
            #pygame.mixer.music.play( -1 )
            sound_effect1.play(-1)
            st = time.time()
            while st + play_time > time.time():
                time.sleep( 1 )

        #sound_flg=random.randint(1,3) 
        #if sound_flg==1:
        #    sound_effect1.play()
        #else:
        #    sound_effect2.play()
